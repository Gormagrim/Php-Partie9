...
Bonus : Le faire en français.</p>
    ...
    $month = array(' ', 'janvier', 'février', 'mars', 'avril', 'mai', 'juin', 'juillet', 'aôut', 'septembre', 'octobre', 'novembre', 'décembre');
    
      echo $day[date('w')]; echo date(' d '); echo $month[date('n')]; echo date(' Y')
    ?>
